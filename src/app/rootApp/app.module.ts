...
import {FirstAppModule} from '../FirstApp/firstApp.module';
import {SecondAppModule} from '../SecondApp/secondApp.module';
...
export class AppModule {
  public static availableApps: any = [FirstAppModule, SecondAppModule];
}
